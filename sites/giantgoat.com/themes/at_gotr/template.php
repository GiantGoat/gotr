 ...
 */
function at_gotr_preprocess_html(&$vars) {
  global $theme_key;
  ...
  //TODO:
  //store site title in var here, and return tag-stripped version.
  //Then reset it back to the full version in at_gotr_preprocess_pane_header
 ...
 */
function at_gotr_preprocess_atpe_site_template(&$vars) {
  global $theme_key;
  $theme_name = $theme_key;
 ...
 * Preprocess Site Template
 */
function at_gotr_preprocess_atpe_site_template_fww(&$vars) {
  global $theme_key;
  $theme_name = $theme_key;
 ...
 * Process pane header
 */
function at_gotr_process_pane_header(&$vars) {
 ...
 */
function at_gotr_preprocess_pane_navigation(&$vars) {
 ...
 * Preprocess pane navigation vars
 */
function at_gotr_process_pane_navigation(&$vars) {
  // theme the menu bars
...
function at_gotr_preprocess_pane_messages(&$vars) {
  $vars['primary_local_tasks'] = menu_primary_local_tasks();
  $vars['secondary_local_tasks'] = menu_secondary_local_tasks();
}

function at_gotr_form_alter(&$form, $form_state, $form_id) {
	if(isset($form_state['view'])) {
		if($form_state['view']->name == 'client_grid') {
			$form['field_tags_tid']['#options']['All'] = t('All'); // overrides "-Any-" in the view filters
		}
	}
}
