 ...
 * on Mon, 10 Nov 2014 09:26:56 -0500.
 *
...
if (isset($_SERVER['db_name'])) {
  ...
  */
  ...
  $conf['file_public_path'] = 'sites/giantgoat.com/files';
  $conf['file_temporary_path'] = 'sites/giantgoat.com/private/temp';
  $conf['file_private_path'] = 'sites/giantgoat.com/private/files';
  $drupal_hash_salt = '';
  $conf['clean_url'] = 1;
  $conf['aegir_api'] = 2;
...
# Extra configuration from modules:
  ...
  if (is_readable('/data/disk/o4875398837/config/includes/global.inc')) {
    include_once('/data/disk/o4875398837/config/includes/global.inc');
  }

  # Additional site configuration settings.
  if (is_readable('/data/disk/o4875398837/static/gotr_1_golden/sites/giantgoat.com/local.settings.php')) {
    include_once('/data/disk/o4875398837/static/gotr_1_golden/sites/giantgoat.com/local.settings.php');
  }
